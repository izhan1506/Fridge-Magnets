...
const BASE_CONFIG: Globe3DConfig = {
  ...
  markerSize: 0.1,
  // Opens on Europe/Africa/the Atlantic, which is where most of the thirteen
  // cities are: 7 of 13 markers face the camera on arrival. Solved numerically
  // against three's Euler XYZ convention, not eyeballed.
